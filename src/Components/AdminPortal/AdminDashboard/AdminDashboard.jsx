...
// import PreviousOrders from '../../UserPortal/PreviousOrders/PreviousOrders';
    ...
    <div className="dashboard-container">
      <div className="sidebar">
        ...
        <nav className="nav-menu">
          ...
          <a className={`nav-item ${activeTab === 'analytics' ? 'active' : ''}`} onClick={() => setActiveTab('analytics')}><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="nav-icon">
