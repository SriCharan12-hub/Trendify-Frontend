        ...
        <div className="home-page">
            ...
            <section className="hero-section">
                ...
                <div class="carousel-inner">
                    ...
                    <img class="carousel-image" src="https://templates.simplified.co/thumb/3446e660-7af3-4ff6-86ce-755afcde8fcd.jpg"  style={{ cursor: "pointer" }}
                        onClick={() => {
                            window.scrollTo(0, 0);
                            document.getElementById('categories-id').scrollIntoView({ behavior: 'smooth' });
                        }} alt="First slide"/>
                    ...
                    <div class="carousel-item">
                    <img class="carousel-image" src="https://i.pinimg.com/1200x/d2/b9/40/d2b940959caadeaf591041c70ab7a0ab.jpg"  style={{ cursor: "pointer" }}
                        onClick={() => {
                            window.scrollTo(0, 0);
                            document.getElementById('categories-id').scrollIntoView({ behavior: 'smooth' });
                        }} alt="Third slide"/>
